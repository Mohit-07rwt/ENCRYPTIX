...
public class number_game {
    public static void main(String args[]) throws IOException {
        ...
        System.out.println("You have to guess that random number.Your score will be the number of attempts you took to guess the number.\n");
        ...
        for (int i = 1; i <= rounds; i++) {
            ...
            System.out.println(
                    "Please Enter the Difficulty Level:\n1 --> Easy [There is Limit of 20 attempts]\n2 --> Hard [There is Limit of 5 attempts]");
            int limits = obj.nextInt();

            switch (limits) {
                case 1: {
                    System.out.println("Opted for Easy Level.\nHence, there is a more  Limits than hard level to number of attempts");
                    System.out.println(
                            "The limit is 20.\nIf you have guessed the number in 20 or less attempts you have won the game.\n Else you will lose the game.\n");
                    int randomNumber = 1 + rand.nextInt(100);
                    System.out.println("Random Number has been generated...");

                    int count = 1;
                    whileloop: while (count <= 20) {
                        System.out.println("\nNo of guesses remaining : " + (21 - count) + " ...\n");
                        System.out.print("Enter you guess number " + count + ": ");
                        int guess = obj.nextInt();
                        if (guess > randomNumber) {
                            System.out.println("The number " + guess
                                    + " is TOO HIGH than Generated Number. You have to Guess again...");
                        } else if (guess < randomNumber) {
                            System.out.println("The number " + guess
                                    + " is TOO LOW than Generated Number. You have to Guess again...");
                        } else {
                            System.out.println(
                    ...
                    if (count > 20) {
                        System.out.println(
                                "OOPS!!! You were not able to guess the number in 20 attempts.\nThe Generated Number was "
